          ...
          <div className="flex flex-col lg:flex-row w-10/12 lg:w-8/12 bg-white rounded-xl mx-auto shadow-lg overflow-hidden">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center  p-12 bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `url(${PetImg2})`, objectFit: "scale-down" }}>
              ...
              <div>
                ...
                <p style={{ color: "rgb(63, 98, 18)" }} className="mb-3 font-semibold text-black">
  Welcome to the Friends furr-ever app! Search for your perfect match, change your life <br />
  <button className="font-bold" style={{ color: "rgb(63, 98, 18)", border: "none", background: "none", cursor: "pointer" }}>Learn more</button>
</p>
