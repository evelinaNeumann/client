      ...
      <div className="px-12">
        <div className="px-4 md:px-12 py-4">
          ...
          <div className="flex flex-col md:flex-row items-center py-4 space-between">
            ...
            <img src={listImg} alt="List for guidelines" className="w-3/5 h-auto md:w-1/4  lg:w-1/4 md:pl-8 mt-4 md:mt-0" />
          </div>
        </div>
        ...
        <div className="flex flex-col items-start px-4 md:px-12 py-4">
          ...
          <div className="flex flex-col py-4">
            ...
            <div className="flex flex-col md:flex-row items-center py-4 space-between">
              ...
              <img src={dogRunning} alt="List for guidelines" className="w-3/5 h-auto md:w-1/4  lg:w-1/4 md:pl-8 mt-4 md:mt-0" />
            </div>
          </div>
<hr></hr>
          <div className="flex flex-col py-4">
            ...
            <div className="flex flex-col md:flex-row items-center py-4 space-between">
              <img src={catGrooming} alt="List for guidelines" className="w-3/5 h-auto md:w-1/4  lg:w-1/4 md:pl-8 mt-4 md:mt-0" />
          ...
          <div className="flex flex-col py-4">
            ...
            <div className="flex flex-col md:flex-row items-center py-4 space-between">
              ...
              <img src={bunny} alt="List for guidelines" className="w-3/5 h-auto md:w-1/4 lg:w-1/4 md:pl-8 mt-4 md:mt-0" />
            </div>
          </div>
        </div>
      </div>
